    ...
    switch (userChoice) {
      ...
      case "4": // check if an item is in the cart
        ...
        System.out.println(
          ...
          (app.shoppingCart.contains(item) ? "Yes" : "No")
        );
        break;
      case "5": // get the frequency of an item in the cart
        ...
        System.out.println(
          ...
          id +
          " in the cart: " +
          app.shoppingCart.getFrequencyOf(item)
        );
        break;
      case "6": // get the number of items in the cart
        System.out.println(
          "There are Currently: " +
          app.shoppingCart.getCurrentSize() +
          " items in the cart"
        );
        break;
      case "7": // check if the cart is empty
        System.out.println(
          "Is the cart empty?\nThe Cart is indeed " +
          (app.shoppingCart.isEmpty() ? "empty!" : "not empty.")
        );
        break;
      case "8": // clear the cart
        System.out.println(
          "Oh no a fellow shopper was sprinting through the store and knocked over your cart!"
        );
      ...
      case "9": // Check if cart is full
        System.out.println(
          "The Cart is full?\nThe Cart is " +
          (app.shoppingCart.isFull() ? "full!" : "not full.")
        );
        break;
      case "10": // toArray
