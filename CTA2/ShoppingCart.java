...
public class ShoppingCart implements BagInterfaceMyType {
  ...
  public void removeFirst(){
    if (isEmpty()) {// if the bag is empty, print a message
      ...
      System.out.println("Removing first item: " + myBag[0].getName() + " with id: " + myBag[0].getId() + " and calories: " + myBag[0].getCalories() + " from the bag");
  ...
  public void display() { // display the items in the bag
    for (int i = 0; i < numberOfItems; i++) {
